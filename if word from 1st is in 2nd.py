#Используется для сравнения списка телефонов от менеджеров со списком телефонов из WD. 
#В первом файле список слов, во втором файле список слов и значений через запятую. 
#Если слово из первого файла есть во втором, то к слову в первом файле через запятую добавляется значение из второго файла. 
#Если слова из первого файла нет во втором файле, оно остается без изменений. Результат записывается вновый файл
